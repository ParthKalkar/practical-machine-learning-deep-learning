# -*- coding: utf-8 -*-
"""Copy of Artistic_Deep_Learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yjhw6-M8Eo1IudS7oAAiS_e6f2FCBJyj
"""
...
"""Getting the model from online Google API"""
...
import imageio
# content_image = imageio.imread("images/cat.jpg")
...
2. Unroll a_C and a_G as explained in the picture above
    - If you are stuck, take a look at [Hint1](https://www.tensorflow.org/api_docs/python/tf/transpose) and [Hint2](https://www.tensorflow.org/versions/api_docs/python/tf/reshape).
...
2. Unroll the hidden layer activations a_S and a_G into 2D matrices, as explained in the picture above.
    - You may find [Hint1](https://www.tensorflow.org/api_docs/python/tf/transpose) and [Hint2](https://www.tensorflow.org/api_docs/python/tf/reshape) useful.
...
for i in range(1, len(sys.argv)):
    list_names.append(sys.argv[i])

c_img_path, s_img_path, g_img_path = list_names
c_img_path = 'images/' + c_img_path
s_img_path = 'images/' + s_img_path

content_image = imageio.imread(c_img_path)
content_image = reshape_and_normalize_image(content_image)

style_image = imageio.imread(s_img_path)
style_image = reshape_and_normalize_image(style_image)

generated_image = generate_noise_image(content_image)
g_img_path = 'output/' + g_img_path
...
def model_nn(sess, input_image, num_iterations=200):
    ...
    save_image(g_img_path, generated_image)
...
Build a python script that resides in the same directory as this ipynb file and can be used as follows:
```python
python3.6 nst_generate.py content.jpg style.jpg generated.jpg
```
This command should generate an image from the content image 'content.jpg' and from the style image 'style.jpg' and save it in 'generated.jpg'. This could be the start of an API or service to use the neural style transfer algorithm.
...
3. Change the code in part (3.4) and part (4) from :
```python
...
## 7 - Deliverables
You should submit your work as:
1. This ipynb file (completed version).
2. The python script 'nst_generate.py', to run you work directly.
3. content, 
4. style, and 
5. generated image of your choice.
6. video generated from the model_nn saved interim images.


These 6 files are forming your work. So, I will check your code in the notebook, and run it from the script on your provided example and another example from us.

## 7 - Notes
* This is a good Tensorflow tutorial [here](https://www.datacamp.com/community/tutorials/tensorflow-tutorial), to refresh your knowledge.
